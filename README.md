...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/wheel-inspect-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15593&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/wheel-inspect-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `wheel-inspect` can be installed with:

```
conda install wheel-inspect
```

It is possible to list all of the versions of `wheel-inspect` available on your platform with:
